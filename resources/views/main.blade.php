    ...
    <div id="page" class="site">
                    ...
                    <div class="container-fluid">               
                        ...
                        <div class="topbar_menu">
                            <ul id="menu-topbar-menu" class="menu clearfix">
                                <li><a href="aabout-us.html">About Us</a></li>
                        ...
                        <div class="topbar_languages">
                            <div id="polylang-2" class="topbar_widget widget_polylang">
                                <div name="lang_choice_polylang-2" id="lang_choice_polylang-2" class="language-button">
                                    {{__('English')}}
                        ...
                        <ul class="topbar-info clearfix">
                            <li><i class="flaticon-placeholder"></i> Erhet Office, Ulaanbaatar, Mongolia </li>
                            <li><i class="flaticon-envelope"></i> fwmedia@mail.com </li>
                        </ul>
                            <!-- contact info close -->
                            ...
                            <div class="octf-mainbar-row octf-row">
                                <div class="octf-col">
                                    <div id="site-logo" class="site-logo">
                                        <a href="index.html">
                                            <img class="logo-static" src="images/fwmedia-logo.png" alt="FW-Media">
                                        </a>
                                    </div>
                                </div>
                                <div class="octf-col">
                                    <nav id="site-navigation" class="main-navigation">           
                                        <ul id="primary-menu" class="menu">
                                            <li class="menu-item-has-children"><a href="/" >Home</a> <!--  Add this class for active tab: current-menu-item current-menu-ancestor -->
                                                <ul class="sub-menu">
                                                    <li><a href="/">Home</a></li>  <!--  Add this class for active tab: current-menu-item -->
                                                    <li><a href="/about-us">About Us</a></li>
                                                    <li><a href="/our-team">Our Team</a></li>
                                                    <li><a href="/single-team">Single Team</a></li>
                                            ...
                                            <li class="menu-item-has-children"><a href="/portfolio-grid">Portfolio</a>
                                                <ul class="sub-menu">
                                                    <li><a href="/portfolio-single">Portfolio Single</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item-has-children"><a href="/contact-us">Contacts</a>
                                                <ul class="sub-menu">
                                                    <li><a href="/free-a-quote">Free a Quote</a></li>
                                                </ul>
                                            </li>
                                        </ul>                             
                                    </nav><!-- #site-navigation -->
                                ...
                                <div class="octf-col text-right">
                                    ...
                                    <div class="octf-btn-cta">
                                        ...
                                        <div class="btn-cta-group btn-cta-header">
                                            <a class="octf-btn octf-btn-third" href="/contact-us">{{__('Contact Us')}}</a>
                                        </div>
                                    </div>
                                    </div>                              
                                </div>
                ...
                <div class="container">
                    <div class="mlogo_wrapper clearfix">
                        <div class="mobile_logo">
                            <a href="index.html"><img src="images/fwmedia-logo.png" alt="FW-Media" data-lazy-src="images/fwmedia-logo.png">
                                <noscript><img src="images/fwmedia-logo.png" alt="FW-Media"></noscript>
                            </a>
                        </div>
                        <div class="octf-btn-cta">
                    ...
                    <div class="mmenu_wrapper">     
                        <div class="mobile_nav">
                            <ul id="menu-main-menu" class="mobile_mainmenu">
                                <li class="menu-item-has-children current-menu-item current-menu-ancestor"><a href="index.html" >Home</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="current-menu-item"><a href="index-5.html">SEO Company</a></li>
        ...
        <footer id="site-footer" class="site-footer site-footer-2 site-footer-5">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <div class="footer-widget">
                                <img src="images/fwmedia-logo.png" class="attachment-full size-full m-b25" alt="">
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="footer-contact-2">
                                    <ul class="font-second">
                                        <li><strong>Address:</strong> Erhet Office<br>Bayan-Zurh District, Ulaanbaatar, Mongolia</li>
                                        <li><strong>Email:</strong> fwmedia@mail.com</li>
                                        <li><strong>Phone:</strong> +976 9554-1132</li>
                                        <li><strong>Open:</strong> 12:00 am – 22:00 pm</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <p class="copyright-2 text-center">Copyright © 2020 FW-Media LLC. All Rights Reserved.</p>
                </div>
            </div>
        </footer><!-- #site-footer -->
    </div><!-- #page -->
