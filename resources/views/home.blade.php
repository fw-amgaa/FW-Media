...
@section('content')
    <div id="content" class="site-content">
            ...
            <div id="rev_slider_three" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                <ul>
                    ...
                    <li data-index="rs-71" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="images/main-slider/slider3/slide2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="1" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="https://via.placeholder.com/1920x793.png" data-bgcolor='#f8f8f8' style='' alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                                                                                
                        <!-- LAYER 3  Thin text title-->
                        <div class="tp-caption   tp-resizeme slider-tag-line" 
                            id="slide-71-layer-3" 
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                            data-y="['top','top','top','top']" data-voffset="['225','140','165','140']" 
                            ...
                            style="z-index: 10; font-weight:900; color: #fff;font-family: 'Red Hat Display', sans-serif;">
                            <h6 class="slider-title">WHAT'S YOUR SEO SCORE</h6>
                        </div>
                            ...
                            <div class="wpcf7">
                                <div class="screen-reader-response">
                                    <form action="seoform.php" method="POST" class="wpcf7-form">
                                        <div class="seo-score one-line-form" style="margin: 0 auto !important; width: max-content">
                                            <span class="wpcf7-form-control-wrap your-url align-start">
                                            ...
                                            <span class="wpcf7-form-control-wrap your-email align-start">
        ...
        <section class="home5-wwa particles-js" data-color="#fe4c1c,#00c3ff,#0160e7" data-id="i5">
            <div class="container">
                <div class="flex-row">
                    <div class="col-md-6 col-sm-12 col-xs-12 text-center align-self-center sm-m-b40">
                        <img src="https://via.placeholder.com/570x641.png" alt="">
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12 align-self-center">
                        <div class="home5-wwa-block">
                            <div class="ot-heading left-align">
                                <h6><span>who we are</span></h6>
                                <h2 class="main-heading">We're on a Mission to<br> Change Your View of SEO</h2>
                            </div>
                            <p class="font22 text-dark">Onum is a values-driven SEO agency dedicated to empowering our customers.</p>
                            <p class="p-b45">Over the years, we have worked with Fortune 500s and brand-new startups. We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.</p>
        ...
        <section class="home5-about particles-js" data-color="#fe4c1c,#00c3ff,#0160e7" data-id="i5-1">
            <div class="container">
                <div class="flex-row">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 align-self-center">
                        <div class="home5-about-block">
                            <div class="ot-heading left-align">
                                ...
                                <h2 class="main-heading">Grow Your Business <br> with Our SEO Agency</h2>
                            </div>
                        ...
                        <div class="flex-row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="icon-box s3 cyan m-t30 text-center">
                                    ...
                                    <div class="icon-main"><span class="flaticon-system"></span></div>
                                    <div class="content-box">
        ...
        <section class="home5-team">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="services-video">
                            <h2>Take Website to Next Level!</h2>
                            <div class="video-popup">
                                <div class="btn-inner">
                                    <a class="btn-play" href="https://vimeo.com/214162786"><i class="fas fa-play"></i>
                                        <span class="circle-1"></span>
            ...
            <div class="container">
                <div class="ot-heading text-center text-light p-t120">
                    <h6 class="text-second"><span>professional people</span></h6>
                    <h2 class="main-heading">Our Leadership Team</h2>
                </div>
                <p class="text-light text-center p-b35">We have experience working with large and small businesses and are ready to<br>develop a targeted strategy and plan that’s just right for you.</p>
            </div>
            <div class="container-fluid p-lr0 p-b150">
                <div class="team-slider-h5">
                    <div class="team-wrap">
                        <div class="team-thumb">
                            <img src="https://via.placeholder.com/357x357.png" alt="">
                        </div>
                        <div class="team-info">
                            <h4>Gina Bruno</h4>
        ...
        <section class="home5-feature particles-js" data-color="#fe4c1c,#00c3ff,#0160e7" data-id="i5-2">
            <div class="container">
                <div class="flex-row">
                    <div class="home7-feature-col1">
                    ...
                    <div class="home7-feature-col2 align-self-center">
                        <div class="feature-col-img">
                            <img src="https://via.placeholder.com/652x512.png" alt="">
                        </div>
                    </div>
                    <div class="home7-feature-col3">
                        <div class="service-box s-box">
                            <div class="overlay"></div>
                        ...
                        <div class="service-box s-box">
                            ...
                            <div class="icon-main number-box"><span class="flaticon-coding"></span></div>
                            <div class="content-box">
                        ...
                        <div class="service-box s-box">
                            ...
                            <div class="icon-main number-box"><span class="flaticon-cloud-computing"></span></div>
                            <div class="content-box">
                                ...
                                <div class="partners-slide">
                                    <a href="#" class="client-logo">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="https://via.placeholder.com/137x31.png" alt="">
                                        </figure>                             
                                    </a>
                                </div>
                                <div class="partners-slide">
        ...
        <section class="home5-projects">
            <div class="container">
                <div class="flex-row p-b20">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="ot-heading left-align">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 text-right xs-text-left align-self-center">
                        <div class="ot-button">
                            <a href="#" class="octf-btn octf-btn-primary octf-btn-icon"><span>All Works <i class="flaticon-right-arrow-1"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 col-xs-12 p-lr0 sm-p-lr15">
                        <div class="project-filter-wrapper">
                            <div class="container xs-p0">
                                <ul class="project_filters project_filters-h5 xs-p0">
                            ...
                            <div class="projects-grid pf_3_cols-s2">
                                <div class="project-item big-style media optimization ">
                                    <div class="projects-box">
                                        <div class="projects-thumbnail">
                                            <a href="portfolio-single.html">
                                                <img src="https://via.placeholder.com/906x438.png" class="" alt="">
                                            </a>
                                        </div>
                                        <div class="portfolio-info s2">
                                ...
                                <div class="project-item development">
                                    <div class="projects-box">
                                        <div class="projects-thumbnail">
                                            <a href="portfolio-single.html">
                                                <img src="https://via.placeholder.com/438x438.png" class="" alt="">
                                            </a>
                                        </div>
                                        <div class="portfolio-info s2">
                                            <div class="portfolio-info-inner">
                                ...
                                <div class="project-item big-style development">
                                    <div class="projects-box">
                                        <div class="projects-thumbnail">
                                            <a href="portfolio-single.html">
                                                <img src="https://via.placeholder.com/906x438.png" class="" alt="">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-13 sm-m-b60">
                        <div class="circle-progress" data-color1="#ff403e" data-color2="#ff811b">
                            <div class="inner-bar" data-percent="75">
                                <span><span class="text-light percent">75</span>%</span>
                            </div>
                            <h4 class="text-light">SEO &amp; Marketing</h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-13 m-t60 sm-m-t0 sm-m-b60">
                        <div class="circle-progress" data-color1="#ff403e" data-color2="#ff811b">
                            <div class="inner-bar" data-percent="43">
                                <span><span class="text-light percent">43</span>%</span>
                            </div>
                            <h4 class="text-light">Keywords Results</h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-13 xs-m-b60">
                        <div class="circle-progress" data-color1="#ff403e" data-color2="#ff811b">
                            <div class="inner-bar" data-percent="66">
                                <span><span class="text-light percent">66</span>%</span>
                            </div>
                            <h4 class="text-light">Google Analytics</h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-13 m-t60 sm-m-t0">
                        <div class="circle-progress" data-color1="#ff403e" data-color2="#ff811b">
                            <div class="inner-bar" data-percent="15">
                                <span><span class="text-light percent">15</span>%</span>
                            </div>
                            <h4 class="text-light">Off Page SEO</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="flex-row">
                        ...
                        <div class="ot-tabs">
                            ...
                            <div id="tab-1454" class="tab-content current">
                                ...
                                <ul class="has-icon unstyle">
                                    <li><i class="flaticon-check"></i> We provide a revolutionary level of transparency into our campaigns - from backlink acquisition.</li>
                                    <li><i class="flaticon-check"></i> Want to test our process before ramping up the budget? We'll prove our model and you'll see revenue soar.</li>
                                </ul>
                            </div>
                    ...
                    <div class="home5-results-img col-md-6 col-sm-12 col-xs-12 text-center align-self-center">
                        <img src="https://via.placeholder.com/569x569.png" alt="">
                    </div>
                </div>
            </div>
        </section>
